...
const Homepage = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-4 gap-4">
      ...
      <div className="bg-primary-foreground p-4 rounded-lg"><PieChartplot/></div>
      <div className="bg-primary-foreground p-4 rounded-lg"><InputOTPDemo/></div>
      <div className="bg-primary-foreground p-4 rounded-lg"><Table/></div>
